    ...
    <div className={`sidebar ${sidebar?"":"small-sidebar"}`}>
        ...
        <div className="subscribe-list">
            ...
            <div className="side-links">
                <img src={simon} alt="" /><p>Sourabh</p>
            </div>
            <div className="side-links">
                <img src={jack} alt="" /><p>Lokesh</p>
            </div>
            <div className="side-links">
                <img src={tom} alt="" /><p>Abir Mondal</p>
            </div>
            <div className="side-links">
                <img src={megan} alt="" /><p>Ishita Das</p>
            </div>
            <div className="side-links">
                <img src={cameron} alt="" /><p>Sayantan</p>
            </div>
            <div className="side-links">
                <img src={tom} alt="" /><p>Abir Mondal</p>
            </div>
